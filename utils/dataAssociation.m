...
state.camState{1,1}.eul = v_InvRotMatrixYPR22(quatToRotMat(state.camState{1,1}.q_C_G));
...
for i = 1 : k_End-k_Start
    ...
    state.camState{1,i+1}.eul = v_InvRotMatrixYPR22(quatToRotMat(state.camState{1,i+1}.q_C_G));
...
for i = 1 : length(state_k)
    ...
    groundT.camState{1,i}.eul = v_InvRotMatrixYPR22(quatToRotMat(groundT.camState{1,i}.q_C_G));
end
