function [PVector,Feature] = FuncGetInitial0(PVector,Feature,Image,PoseID,K)
...
for i=1:nRowNum-1;
    ...
    if FID > nRowNumF;
        ...
        V1 = Funcuv2V(Image(i+1,2:3),Image(1,1:3),K);
...
%         clear V1 V2;
    ...
    Omegai = [];
        if PVector.Feature(3*FID,1)<0.008;           
            V2 = Funcuv2V(Image(i+1,2:3),Image(1,1:3),K);
            ...
            [Max,ID] = max(Omegai);
            if Max>PVector.Feature(3*FID,1)*1.2 || Max>0.008;
