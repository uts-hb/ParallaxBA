function [PVector,Feature] = FuncGetInitial2(PVector,Feature,Image,PoseID,K)
...
for i=1:nRowNum-1;
    ...
    if FID > nRowNumF;
        ...
        V1 = Funcuv2V(Feature(FID,7:8),Image(1,1:3),K);
    ...
    elseif Feature(FID,5) == 1;
        ...
        V2 = Funcuv2V(Feature(FID,10:11),Image(1,1:3),K);
        PVector.Omega(FID,1) = FuncV2O(V1,V2);
        clear V1 V2;
        continue;
    
    elseif Feature(FID,5) >= 2;                
%         if PVector.Omega(FID,1)<0.00;           
%             V2 = Funcuv2V(Image(i+1,2:3),Image(1,1:3),K);
