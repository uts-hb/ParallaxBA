...
function [DeltaP,DeltaF,Sum_Delta] = FuncDeltaLMSBA(Info,E,Lambda,PVector,Feature,FixVa)
...
%     DeltaP = [zeros(6,1);DeltaP(1:53);0;DeltaP(54:nRowNumP-7)];
